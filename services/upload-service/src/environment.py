...
class DatabaseSettings(BaseSettings):
    ...
    user: str = Field(default="upload_user", validation_alias="DATABASE_USER")
    password: str = Field(default="upload_pass", validation_alias="DATABASE_PASSWORD")
    name: str = Field(default="upload_db", validation_alias="DATABASE_NAME")
...
class RabbitMQSettings(BaseSettings):
    ...
    queue_name: str = Field(default="upload-service.status-updates", validation_alias="RABBITMQ_QUEUE_NAME")
...
class AppSettings(BaseSettings):
    ...
    service_name: str = Field(default="upload-service", validation_alias="SERVICE_NAME")
